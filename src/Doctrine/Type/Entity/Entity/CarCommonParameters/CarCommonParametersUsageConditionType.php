...
final class CarCommonParametersUsageConditionType extends AbstractStringNotNullContextType
{
    public function convertToPHPValue($value, AbstractPlatform $platform): UsageCondition
    {
        if (!is_string($value)) {
        ...
        return new UsageCondition($value);
    }
}